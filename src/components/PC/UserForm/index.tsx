...
const UserForm = () => {
  ...
  return (
    ...
    >
      ...
      <Image src='/img/highlight.png' width={400} height={106} alt="" className=" absolute top-[-60px] left-[120px]" />
      <div className={style.userForm}>
        <Image className="mt-[10px]" src='/img/userTitle.png' width={417} height={72} alt="" />
